...
class Swiper {
    ...
    mount(el) {
        ...
        const getWrapper = ()=>{
            ...
            if (!$el.children) return _domJsDefault.default($el).children(getWrapperSelector());
...
function updateAutoHeight(speed) {
    ...
    if (swiper.params.slidesPerView !== 'auto' && swiper.params.slidesPerView > 1) {
        if (swiper.params.centeredSlides) (swiper.visibleSlides || _domJsDefault.default([])).each((slide)=>{
...
},{"../../shared/create-shadow.js":"9JYAP","../../shared/effect-init.js":"5DnvG","../../shared/effect-target.js":"eKqS8","../../shared/effect-virtual-transition-end.js":"VhYFx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["54dwi","1SICI"], "1SICI", "parcelRequire6889")
